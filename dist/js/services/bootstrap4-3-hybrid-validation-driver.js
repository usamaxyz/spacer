...
/*!******************************************************************!*\
  !*** ./src/js/services/bootstrap4-3-hybrid-validation-driver.js ***!
  \******************************************************************/
window.bootstrap43HybridValidationDriver = {
  ...
  clearError: function clearError(inputJq) {
    inputJq.removeClass('is-invalid').closest('[class*="form-group"]').removeClass('has-error has-danger').find('.invalid-feedback').html(''); //confirm input
